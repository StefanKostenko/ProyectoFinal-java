...
public class Principal extends JFrame implements ActionListener{
    ...
    public Principal() {
      ...
      labelBienvenido.setFont(new Font("Andale Mono", 1, 28));
      ...
      comboAntiguedad.addItem("1 periodo de servicio");
      comboAntiguedad.addItem("2 a 6 periodo de servicio");
      comboAntiguedad.addItem("7 periodo o mas de servicio");
            ...
            if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") ||
               Departamento.equals("") || Antiguedad.equals("")){
                ...
                if(Departamento.equals("Atencion al Cliente")){
                                ...
                                if(Antiguedad.equals("1 periodo de servicio")){
					textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + 
                                                          "\n   quien labora en " + Departamento + " con " + Antiguedad + 
                                                          "\n   recibe 6 dias de vacaciones.");
				}
				if(Antiguedad.equals("2 a 6 periodo de servicio")){
					textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + 
                                                          "\n   quien labora en " + Departamento + " con " + Antiguedad + 
                                                          "\n   recibe 14 dias de vacaciones.");
				}
				if(Antiguedad.equals("7 periodo o mas de servicio")){
					textarea1.setText("\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + 
                                                          "\n   quien labora en " + Departamento + " con " + Antiguedad + 
	...
	if (e.getSource() == miSalir){
        ...
        if (e.getSource() == miElCreador){
            ...
            JOptionPane.showMessageDialog(null,"Desarrollado por Stefan Kostenko\n"+
                                               "    kostenkostephan@gmail.com");
        }
    }
